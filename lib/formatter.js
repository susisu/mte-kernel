 ...
 * If the index specifies the header row, the cells are emptied but the row is not removed.
 * The delimiter row will not be deleted by this function, even if the index specifies it.
 *
 * @param {Table} table - A (non-empty) table object.
 ...
 * If there will be no columns after the deletion, the cells are emptied but the column is not
 * removed.
 *
 * @param {Table} table - A (non-empty) table object.
